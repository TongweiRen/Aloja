...
class InsertWrapperStruct:
    ...
    def insertWrapperStruct(self):
        ...
        nonce_list_str = "@Aloja_Wrapper_Function.nonce_list = private unnamed_addr constant [4 x i16] [i16 13, i16 28, i16 92, i16 65], align 2\n"
    ...
    def insertWrapperFunction(self, datas):
        ...
        wdir = os.getcwd()
        with open(wdir + "/templates/int16/wrapper_function_int16.txt", 'r') as f:
