...
class InsertReadWrapperCall:
    ...
    def insertReadWrapperCall(self):
        ...
        # console.print(added_instruction_number)

        
        for item in GEPs:
            added_instructions.append(item)
        current_numb = added_instruction_number + len(added_instructions) - 1
        instruction_0 = f"  %{current_numb+1} = load i64, i64* %{current_numb}, align 4\n"
        instruction_1 = f"  %{current_numb+2} = call i64 @Aloja_Wrapper_Function(i64 %{current_numb+1})\n"
        ...
        instruction_store = f"  store i64 %{current_numb+2}, i64* %{current_numb_2}, align 8\n"
