...
class InsertWrapperStruct:
    ...
    def insertWrapperStruct(self):
        ...
        nonce_list_str = "@Aloja_Wrapper_Function.nonce_list = private unnamed_addr constant [4 x i32] [i32 13, i32 28, i32 92, i32 65], align 16\n"
    ...
    def insertWrapperFunction(self, datas):
        ...
        wdir = os.getcwd()
        with open(wdir + "/templates/int32/wrapper_function_int32.txt", 'r') as f:
