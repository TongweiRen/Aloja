...
define dso_local i64 @__mqtt_send(%struct.mqtt_client.7* %0) #0 !dbg !1369 {
  ...
  %13 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1380
  %14 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %13, i32 0, i32 16, !dbg !1380
  %15 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* %14) #10, !dbg !1380
  %16 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1381
  %17 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %16, i32 0, i32 6, !dbg !1383
  %18 = load i32, i32* %17, align 8, !dbg !1383
  %19 = icmp slt i32 %18, 0, !dbg !1384
  br i1 %19, label %20, label %33, !dbg !1385

20:                                               ; preds = %1
  %21 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1386
  %22 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %21, i32 0, i32 6, !dbg !1387
  %23 = load i32, i32* %22, align 8, !dbg !1387
  %24 = icmp ne i32 %23, -2147483632, !dbg !1388
  br i1 %24, label %25, label %33, !dbg !1389

25:                                               ; preds = %20
  %26 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1390
  %27 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %26, i32 0, i32 16, !dbg !1390
  %28 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %27) #10, !dbg !1390
  %29 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1392
  %30 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %29, i32 0, i32 6, !dbg !1393
  %31 = load i32, i32* %30, align 8, !dbg !1393
  %32 = sext i32 %31 to i64, !dbg !1392
  store i64 %32, i64* %2, align 8, !dbg !1394
  br label %278, !dbg !1394

33:                                               ; preds = %20, %1
  %34 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1395
  %35 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %34, i32 0, i32 17, !dbg !1395
  %36 = getelementptr inbounds %struct.mqtt_message_queue, %struct.mqtt_message_queue* %35, i32 0, i32 1, !dbg !1395
  %37 = load i8*, i8** %36, align 8, !dbg !1395
  %38 = bitcast i8* %37 to %struct.mqtt_queued_message*, !dbg !1395
  %39 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1395
  %40 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %39, i32 0, i32 17, !dbg !1395
  %41 = getelementptr inbounds %struct.mqtt_message_queue, %struct.mqtt_message_queue* %40, i32 0, i32 4, !dbg !1395
  %42 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %41, align 8, !dbg !1395
  %43 = ptrtoint %struct.mqtt_queued_message* %38 to i64, !dbg !1395
  %44 = ptrtoint %struct.mqtt_queued_message* %42 to i64, !dbg !1395
  %45 = sub i64 %43, %44, !dbg !1395
  %46 = sdiv exact i64 %45, 40, !dbg !1395
  store i64 %46, i64* %5, align 8, !dbg !1396
  br label %47, !dbg !1397

47:                                               ; preds = %240, %33
  %48 = load i32, i32* %7, align 4, !dbg !1398
  %49 = sext i32 %48 to i64, !dbg !1398
  %50 = load i64, i64* %5, align 8, !dbg !1401
  %51 = icmp slt i64 %49, %50, !dbg !1402
  br i1 %51, label %52, label %243, !dbg !1403

52:                                               ; preds = %47
  call void @llvm.dbg.declare(metadata %struct.mqtt_queued_message** %8, metadata !1404, metadata !DIExpression()), !dbg !1406
  %53 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1407
  %54 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %53, i32 0, i32 17, !dbg !1407
  %55 = getelementptr inbounds %struct.mqtt_message_queue, %struct.mqtt_message_queue* %54, i32 0, i32 1, !dbg !1407
  %56 = load i8*, i8** %55, align 8, !dbg !1407
  %57 = bitcast i8* %56 to %struct.mqtt_queued_message*, !dbg !1407
  %58 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %57, i64 -1, !dbg !1407
  %59 = load i32, i32* %7, align 4, !dbg !1407
  %60 = sext i32 %59 to i64, !dbg !1407
  %61 = sub i64 0, %60, !dbg !1407
  %62 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %58, i64 %61, !dbg !1407
  store %struct.mqtt_queued_message* %62, %struct.mqtt_queued_message** %8, align 8, !dbg !1406
  call void @llvm.dbg.declare(metadata i32* %9, metadata !1408, metadata !DIExpression()), !dbg !1409
  store i32 0, i32* %9, align 4, !dbg !1409
  %63 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1410
  %64 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %63, i32 0, i32 2, !dbg !1412
  %65 = load i32, i32* %64, align 8, !dbg !1412
  %66 = icmp eq i32 %65, 0, !dbg !1413
  br i1 %66, label %67, label %68, !dbg !1414
...
68:                                               ; preds = %52
  %69 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1418
  %70 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %69, i32 0, i32 2, !dbg !1420
  %71 = load i32, i32* %70, align 8, !dbg !1420
  %72 = icmp eq i32 %71, 1, !dbg !1421
  br i1 %72, label %73, label %92, !dbg !1422

73:                                               ; preds = %68
  %74 = call i64 @time(i64* null) #10, !dbg !1423
  %75 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1426
  %76 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %75, i32 0, i32 3, !dbg !1427
  %77 = load i64, i64* %76, align 8, !dbg !1427
  %78 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1428
  %79 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %78, i32 0, i32 7, !dbg !1429
  %80 = load i32, i32* %79, align 4, !dbg !1429
  %81 = sext i32 %80 to i64, !dbg !1428
  %82 = add nsw i64 %77, %81, !dbg !1430
  %83 = icmp sgt i64 %74, %82, !dbg !1431
  br i1 %83, label %84, label %91, !dbg !1432

84:                                               ; preds = %73
  store i32 1, i32* %9, align 4, !dbg !1433
  %85 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1435
  %86 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %85, i32 0, i32 8, !dbg !1436
  %87 = load i32, i32* %86, align 8, !dbg !1437
  %88 = add nsw i32 %87, 1, !dbg !1437
  store i32 %88, i32* %86, align 8, !dbg !1437
  %89 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1438
  %90 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %89, i32 0, i32 4, !dbg !1439
  store i64 0, i64* %90, align 8, !dbg !1440
  br label %91, !dbg !1441
...
93:                                               ; preds = %92, %67
  %94 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1443
  %95 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %94, i32 0, i32 4, !dbg !1445
  %96 = load i32, i32* %95, align 8, !dbg !1445
  %97 = icmp eq i32 %96, 3, !dbg !1446
  br i1 %97, label %98, label %127, !dbg !1447

98:                                               ; preds = %93
  %99 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1448
  %100 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %99, i32 0, i32 2, !dbg !1449
  %101 = load i32, i32* %100, align 8, !dbg !1449
  %102 = icmp eq i32 %101, 0, !dbg !1450
  br i1 %102, label %108, label %103, !dbg !1451

103:                                              ; preds = %98
  %104 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1452
  %105 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %104, i32 0, i32 2, !dbg !1453
  %106 = load i32, i32* %105, align 8, !dbg !1453
  %107 = icmp eq i32 %106, 1, !dbg !1454
  br i1 %107, label %108, label %127, !dbg !1455

108:                                              ; preds = %103, %98
  %109 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1456
  %110 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %109, i32 0, i32 0, !dbg !1458
  %111 = load i8*, i8** %110, align 8, !dbg !1458
  %112 = getelementptr inbounds i8, i8* %111, i64 0, !dbg !1456
  %113 = load i8, i8* %112, align 1, !dbg !1456
  %114 = zext i8 %113 to i32, !dbg !1459
  %115 = ashr i32 %114, 1, !dbg !1460
  %116 = and i32 3, %115, !dbg !1461
  %117 = trunc i32 %116 to i8, !dbg !1462
  store i8 %117, i8* %4, align 1, !dbg !1463
  %118 = load i8, i8* %4, align 1, !dbg !1464
  %119 = zext i8 %118 to i32, !dbg !1464
  %120 = icmp eq i32 %119, 2, !dbg !1466
  br i1 %120, label %121, label %126, !dbg !1467

121:                                              ; preds = %108
  %122 = load i32, i32* %6, align 4, !dbg !1468
  %123 = icmp ne i32 %122, 0, !dbg !1468
  br i1 %123, label %124, label %125, !dbg !1471
...
125:                                              ; preds = %124, %121
  ...
  br label %126, !dbg !1476

126:                                              ; preds = %125, %108
  br label %127, !dbg !1477

127:                                              ; preds = %126, %103, %93
  %128 = load i32, i32* %9, align 4, !dbg !1478
  %129 = icmp ne i32 %128, 0, !dbg !1478
  br i1 %129, label %131, label %130, !dbg !1480

130:                                              ; preds = %127
  br label %240, !dbg !1481

131:                                              ; preds = %127
  call void @llvm.dbg.declare(metadata i64* %10, metadata !1483, metadata !DIExpression()), !dbg !1485
  %132 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1486
  %133 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %132, i32 0, i32 0, !dbg !1487
  %134 = load i32, i32* %133, align 8, !dbg !1487
  %135 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1488
  %136 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %135, i32 0, i32 0, !dbg !1489
  %137 = load i8*, i8** %136, align 8, !dbg !1489
  %138 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1490
  %139 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %138, i32 0, i32 4, !dbg !1491
  %140 = load i64, i64* %139, align 8, !dbg !1491
  %141 = getelementptr inbounds i8, i8* %137, i64 %140, !dbg !1492
  %142 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1493
  %143 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %142, i32 0, i32 1, !dbg !1494
  %144 = load i64, i64* %143, align 8, !dbg !1494
  %145 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1495
  %146 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %145, i32 0, i32 4, !dbg !1496
  %147 = load i64, i64* %146, align 8, !dbg !1496
  %148 = sub i64 %144, %147, !dbg !1497
  %149 = call i64 @mqtt_pal_sendall(i32 %134, i8* %141, i64 %148, i32 0), !dbg !1498
  store i64 %149, i64* %10, align 8, !dbg !1485
  %150 = load i64, i64* %10, align 8, !dbg !1499
  %151 = icmp slt i64 %150, 0, !dbg !1501
  br i1 %151, label %152, label %161, !dbg !1502

152:                                              ; preds = %131
  %153 = load i64, i64* %10, align 8, !dbg !1503
  %154 = trunc i64 %153 to i32, !dbg !1503
  %155 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1505
  %156 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %155, i32 0, i32 6, !dbg !1506
  store i32 %154, i32* %156, align 8, !dbg !1507
  %157 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1508
  %158 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %157, i32 0, i32 16, !dbg !1508
  %159 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %158) #10, !dbg !1508
  %160 = load i64, i64* %10, align 8, !dbg !1509
  store i64 %160, i64* %2, align 8, !dbg !1510
  br label %278, !dbg !1510

161:                                              ; preds = %131
  %162 = load i64, i64* %10, align 8, !dbg !1511
  %163 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1513
  %164 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %163, i32 0, i32 4, !dbg !1514
  %165 = load i64, i64* %164, align 8, !dbg !1515
  %166 = add i64 %165, %162, !dbg !1515
  store i64 %166, i64* %164, align 8, !dbg !1515
  %167 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1516
  %168 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %167, i32 0, i32 4, !dbg !1518
  %169 = load i64, i64* %168, align 8, !dbg !1518
  %170 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1519
  %171 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %170, i32 0, i32 1, !dbg !1520
  %172 = load i64, i64* %171, align 8, !dbg !1520
  %173 = icmp ult i64 %169, %172, !dbg !1521
  br i1 %173, label %174, label %175, !dbg !1522

174:                                              ; preds = %161
  br label %243, !dbg !1523

175:                                              ; preds = %161
  %176 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1525
  %177 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %176, i32 0, i32 4, !dbg !1527
  store i64 0, i64* %177, align 8, !dbg !1528
  br label %178
...
179:                                              ; preds = %178
  %180 = call i64 @time(i64* null) #10, !dbg !1529
  %181 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1530
  %182 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %181, i32 0, i32 5, !dbg !1531
  store i64 %180, i64* %182, align 8, !dbg !1532
  %183 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1533
  %184 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %183, i32 0, i32 5, !dbg !1534
  %185 = load i64, i64* %184, align 8, !dbg !1534
  %186 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1535
  %187 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %186, i32 0, i32 3, !dbg !1536
  store i64 %185, i64* %187, align 8, !dbg !1537
  %188 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1538
  %189 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %188, i32 0, i32 4, !dbg !1539
  %190 = load i32, i32* %189, align 8, !dbg !1539
...
191:                                              ; preds = %179, %179, %179
  %192 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1541
  %193 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %192, i32 0, i32 2, !dbg !1543
  store i32 2, i32* %193, align 8, !dbg !1544
  br label %239, !dbg !1545

194:                                              ; preds = %179
  %195 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1546
  %196 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %195, i32 0, i32 0, !dbg !1547
  %197 = load i8*, i8** %196, align 8, !dbg !1547
  %198 = getelementptr inbounds i8, i8* %197, i64 0, !dbg !1546
  %199 = load i8, i8* %198, align 1, !dbg !1546
  %200 = zext i8 %199 to i32, !dbg !1548
  %201 = and i32 6, %200, !dbg !1549
  %202 = ashr i32 %201, 1, !dbg !1550
  %203 = trunc i32 %202 to i8, !dbg !1551
  store i8 %203, i8* %4, align 1, !dbg !1552
  %204 = load i8, i8* %4, align 1, !dbg !1553
  %205 = zext i8 %204 to i32, !dbg !1553
  %206 = icmp eq i32 %205, 0, !dbg !1555
  br i1 %206, label %207, label %210, !dbg !1556

207:                                              ; preds = %194
  %208 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1557
  %209 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %208, i32 0, i32 2, !dbg !1559
  store i32 2, i32* %209, align 8, !dbg !1560
  br label %229, !dbg !1561

210:                                              ; preds = %194
  %211 = load i8, i8* %4, align 1, !dbg !1562
  %212 = zext i8 %211 to i32, !dbg !1562
  %213 = icmp eq i32 %212, 1, !dbg !1564
  br i1 %213, label %214, label %225, !dbg !1565

214:                                              ; preds = %210
  %215 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1566
  %216 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %215, i32 0, i32 2, !dbg !1568
  store i32 1, i32* %216, align 8, !dbg !1569
  %217 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1570
  %218 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %217, i32 0, i32 0, !dbg !1571
  %219 = load i8*, i8** %218, align 8, !dbg !1571
  %220 = getelementptr inbounds i8, i8* %219, i64 0, !dbg !1570
  %221 = load i8, i8* %220, align 1, !dbg !1572
  %222 = zext i8 %221 to i32, !dbg !1572
  %223 = or i32 %222, 8, !dbg !1572
  %224 = trunc i32 %223 to i8, !dbg !1572
  store i8 %224, i8* %220, align 1, !dbg !1572
  br label %228, !dbg !1573

225:                                              ; preds = %210
  %226 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1574
  %227 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %226, i32 0, i32 2, !dbg !1576
  store i32 1, i32* %227, align 8, !dbg !1577
  br label %228
...
229:                                              ; preds = %228, %207
  br label %239, !dbg !1578

230:                                              ; preds = %179, %179, %179, %179, %179, %179
  %231 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %8, align 8, !dbg !1579
  %232 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %231, i32 0, i32 2, !dbg !1580
  store i32 1, i32* %232, align 8, !dbg !1581
  br label %239, !dbg !1582

233:                                              ; preds = %179
  %234 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1583
  %235 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %234, i32 0, i32 6, !dbg !1584
  store i32 -2147483630, i32* %235, align 8, !dbg !1585
  %236 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1586
  %237 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %236, i32 0, i32 16, !dbg !1586
  %238 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %237) #10, !dbg !1586
  store i64 -2147483630, i64* %2, align 8, !dbg !1587
  br label %278, !dbg !1587

239:                                              ; preds = %230, %229, %191
  br label %240, !dbg !1588

240:                                              ; preds = %239, %130
  %241 = load i32, i32* %7, align 4, !dbg !1589
  %242 = add nsw i32 %241, 1, !dbg !1589
  store i32 %242, i32* %7, align 4, !dbg !1589
  br label %47, !dbg !1590, !llvm.loop !1591

243:                                              ; preds = %174, %47
  call void @llvm.dbg.declare(metadata i64* %11, metadata !1593, metadata !DIExpression()), !dbg !1595
  %244 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1596
  %245 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %244, i32 0, i32 5, !dbg !1597
  %246 = load i64, i64* %245, align 8, !dbg !1597
  %247 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1598
  %248 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %247, i32 0, i32 2, !dbg !1599
  %249 = load i16, i16* %248, align 2, !dbg !1599
  %250 = uitofp i16 %249 to float, !dbg !1600
  %251 = fpext float %250 to double, !dbg !1600
  %252 = fmul double %251, 7.500000e-01, !dbg !1601
  %253 = fptosi double %252 to i64, !dbg !1602
  %254 = add nsw i64 %246, %253, !dbg !1603
  store i64 %254, i64* %11, align 8, !dbg !1595
  %255 = call i64 @time(i64* null) #10, !dbg !1604
  %256 = load i64, i64* %11, align 8, !dbg !1606
  %257 = icmp sgt i64 %255, %256, !dbg !1607
  br i1 %257, label %258, label %274, !dbg !1608

258:                                              ; preds = %243
  call void @llvm.dbg.declare(metadata i64* %12, metadata !1609, metadata !DIExpression()), !dbg !1611
  %259 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1612
  %260 = call i32 @__mqtt_ping(%struct.mqtt_client.7* %259), !dbg !1613
  %261 = sext i32 %260 to i64, !dbg !1613
  store i64 %261, i64* %12, align 8, !dbg !1611
  %262 = load i64, i64* %12, align 8, !dbg !1614
  %263 = icmp ne i64 %262, 1, !dbg !1616
  br i1 %263, label %264, label %273, !dbg !1617

264:                                              ; preds = %258
  %265 = load i64, i64* %12, align 8, !dbg !1618
  %266 = trunc i64 %265 to i32, !dbg !1618
  %267 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1620
  %268 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %267, i32 0, i32 6, !dbg !1621
  store i32 %266, i32* %268, align 8, !dbg !1622
  %269 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1623
  %270 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %269, i32 0, i32 16, !dbg !1623
  %271 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %270) #10, !dbg !1623
  %272 = load i64, i64* %12, align 8, !dbg !1624
  store i64 %272, i64* %2, align 8, !dbg !1625
  br label %278, !dbg !1625

273:                                              ; preds = %258
  br label %274, !dbg !1626

274:                                              ; preds = %273, %243
  %275 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %3, align 8, !dbg !1627
  %276 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %275, i32 0, i32 16, !dbg !1627
  %277 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %276) #10, !dbg !1627
  store i64 1, i64* %2, align 8, !dbg !1628
  br label %278, !dbg !1628

278:                                              ; preds = %274, %264, %233, %152, %25
  %279 = load i64, i64* %2, align 8, !dbg !1629
  ret i64 %279, !dbg !1629
}
