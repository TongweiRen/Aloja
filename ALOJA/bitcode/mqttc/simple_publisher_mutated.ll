...
@change_static_value.nonce = private unnamed_addr constant [4 x i16] [i16 1337, i16 28, i16 92, i16 65], align 2
...
11:                                               ; preds = %1
  ...
  %13 = call i64 @time(i64* %5) #10
  %14 = call %struct.tm* @gmtime(i64* %5) #10
...
define dso_local i32 @mqtt_connect(%struct.mqtt_client.7* %0, i8* %1, i8* %2, i8* %3, i64 %4, i8* %5, i8* %6, i8 zeroext %7, i16 zeroext %8) #0 !dbg !3189 {
  ...
  %25 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8
  %26 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %25, i32 0, i32 2
  %27 = load i16, i16* %26, align 2
  %28 = call i16 @change_static_value(i16 %27)
  %29 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8
  %30 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %29, i32 0, i32 2
  store i16 %28, i16* %30, align 2
  %31 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3218
  %32 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %31, i32 0, i32 6, !dbg !3220
  %33 = load i32, i32* %32, align 8, !dbg !3220
  %34 = icmp eq i32 %33, -2147483633, !dbg !3221
  br i1 %34, label %35, label %38, !dbg !3222

35:                                               ; preds = %9
  %36 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3223
  %37 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %36, i32 0, i32 6, !dbg !3225
  store i32 1, i32* %37, align 8, !dbg !3226
  br label %38, !dbg !3227

38:                                               ; preds = %35, %9
  %39 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3228
  %40 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %39, i32 0, i32 6, !dbg !3228
  %41 = load i32, i32* %40, align 8, !dbg !3228
  %42 = icmp slt i32 %41, 0, !dbg !3228
  br i1 %42, label %43, label %50, !dbg !3230

43:                                               ; preds = %38
  %44 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3231
  %45 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %44, i32 0, i32 16, !dbg !3231
  %46 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %45) #10, !dbg !3231
  %47 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3234
  %48 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %47, i32 0, i32 6, !dbg !3234
  %49 = load i32, i32* %48, align 8, !dbg !3234
  store i32 %49, i32* %10, align 4, !dbg !3234
  br label %137, !dbg !3234

50:                                               ; preds = %38
  %51 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3230
  %52 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %51, i32 0, i32 17, !dbg !3230
  %53 = getelementptr inbounds %struct.mqtt_message_queue, %struct.mqtt_message_queue* %52, i32 0, i32 2, !dbg !3230
  %54 = load i8*, i8** %53, align 8, !dbg !3230
  %55 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3230
  %56 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %55, i32 0, i32 17, !dbg !3230
  %57 = getelementptr inbounds %struct.mqtt_message_queue, %struct.mqtt_message_queue* %56, i32 0, i32 3, !dbg !3230
  %58 = load i64, i64* %57, align 8, !dbg !3230
  %59 = load i8*, i8** %12, align 8, !dbg !3230
  %60 = load i8*, i8** %13, align 8, !dbg !3230
  %61 = load i8*, i8** %14, align 8, !dbg !3230
  %62 = load i64, i64* %15, align 8, !dbg !3230
  %63 = load i8*, i8** %16, align 8, !dbg !3230
  %64 = load i8*, i8** %17, align 8, !dbg !3230
  %65 = load i8, i8* %18, align 1, !dbg !3230
  %66 = load i16, i16* %19, align 2, !dbg !3230
  %67 = call i64 @mqtt_pack_connection_request(i8* %54, i64 %58, i8* %59, i8* %60, i8* %61, i64 %62, i8* %63, i8* %64, i8 zeroext %65, i16 zeroext %66), !dbg !3230
  store i64 %67, i64* %20, align 8, !dbg !3230
  %68 = load i64, i64* %20, align 8, !dbg !3235
  %69 = icmp slt i64 %68, 0, !dbg !3235
  br i1 %69, label %70, label %80, !dbg !3230

70:                                               ; preds = %50
  %71 = load i64, i64* %20, align 8, !dbg !3237
  %72 = trunc i64 %71 to i32, !dbg !3237
  %73 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3237
  %74 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %73, i32 0, i32 6, !dbg !3237
  store i32 %72, i32* %74, align 8, !dbg !3237
  %75 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3239
  %76 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %75, i32 0, i32 16, !dbg !3239
  %77 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %76) #10, !dbg !3239
  %78 = load i64, i64* %20, align 8, !dbg !3237
  %79 = trunc i64 %78 to i32, !dbg !3237
  store i32 %79, i32* %10, align 4, !dbg !3237
  br label %137, !dbg !3237

80:                                               ; preds = %50
  %81 = load i64, i64* %20, align 8, !dbg !3241
  %82 = icmp eq i64 %81, 0, !dbg !3241
  br i1 %82, label %83, label %126, !dbg !3235
...
83:                                               ; preds = %80
  ...
  call void @mqtt_mq_clean(%struct.mqtt_message_queue* %85), !dbg !3243
  %86 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3243
  %87 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %86, i32 0, i32 17, !dbg !3243
  %88 = getelementptr inbounds %struct.mqtt_message_queue, %struct.mqtt_message_queue* %87, i32 0, i32 2, !dbg !3243
  %89 = load i8*, i8** %88, align 8, !dbg !3243
  %90 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3243
  %91 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %90, i32 0, i32 17, !dbg !3243
  %92 = getelementptr inbounds %struct.mqtt_message_queue, %struct.mqtt_message_queue* %91, i32 0, i32 3, !dbg !3243
  %93 = load i64, i64* %92, align 8, !dbg !3243
  %94 = load i8*, i8** %12, align 8, !dbg !3243
  %95 = load i8*, i8** %13, align 8, !dbg !3243
  %96 = load i8*, i8** %14, align 8, !dbg !3243
  %97 = load i64, i64* %15, align 8, !dbg !3243
  %98 = load i8*, i8** %16, align 8, !dbg !3243
  %99 = load i8*, i8** %17, align 8, !dbg !3243
  %100 = load i8, i8* %18, align 1, !dbg !3243
  %101 = load i16, i16* %19, align 2, !dbg !3243
  %102 = call i64 @mqtt_pack_connection_request(i8* %89, i64 %93, i8* %94, i8* %95, i8* %96, i64 %97, i8* %98, i8* %99, i8 zeroext %100, i16 zeroext %101), !dbg !3243
  store i64 %102, i64* %20, align 8, !dbg !3243
  %103 = load i64, i64* %20, align 8, !dbg !3245
  %104 = icmp slt i64 %103, 0, !dbg !3245
  br i1 %104, label %105, label %115, !dbg !3243

105:                                               ; preds = %83
  %106 = load i64, i64* %20, align 8, !dbg !3247
  %107 = trunc i64 %106 to i32, !dbg !3247
  %108 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3247
  %109 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %108, i32 0, i32 6, !dbg !3247
  store i32 %107, i32* %109, align 8, !dbg !3247
  %110 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3249
  %111 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %110, i32 0, i32 16, !dbg !3249
  %112 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %111) #10, !dbg !3249
  %113 = load i64, i64* %20, align 8, !dbg !3247
  %114 = trunc i64 %113 to i32, !dbg !3247
  store i32 %114, i32* %10, align 4, !dbg !3247
  br label %137, !dbg !3247

115:                                              ; preds = %83
  %116 = load i64, i64* %20, align 8, !dbg !3251
  %117 = icmp eq i64 %116, 0, !dbg !3251
  br i1 %117, label %118, label %124, !dbg !3245

118:                                              ; preds = %115
  %119 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3253
  %120 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %119, i32 0, i32 6, !dbg !3253
  store i32 -2147483632, i32* %120, align 8, !dbg !3253
  %121 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3255
  %122 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %121, i32 0, i32 16, !dbg !3255
  %123 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %122) #10, !dbg !3255
  store i32 -2147483632, i32* %10, align 4, !dbg !3253
  br label %137, !dbg !3253
...
127:                                              ; preds = %126
  %128 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3230
  %129 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %128, i32 0, i32 17, !dbg !3230
  %130 = load i64, i64* %20, align 8, !dbg !3230
  %131 = call %struct.mqtt_queued_message* @mqtt_mq_register(%struct.mqtt_message_queue* %129, i64 %130), !dbg !3230
  store %struct.mqtt_queued_message* %131, %struct.mqtt_queued_message** %21, align 8, !dbg !3230
  %132 = load %struct.mqtt_queued_message*, %struct.mqtt_queued_message** %21, align 8, !dbg !3257
  %133 = getelementptr inbounds %struct.mqtt_queued_message, %struct.mqtt_queued_message* %132, i32 0, i32 4, !dbg !3258
  store i32 1, i32* %133, align 8, !dbg !3259
  %134 = load %struct.mqtt_client.7*, %struct.mqtt_client.7** %11, align 8, !dbg !3260
  %135 = getelementptr inbounds %struct.mqtt_client.7, %struct.mqtt_client.7* %134, i32 0, i32 16, !dbg !3260
  %136 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %135) #10, !dbg !3260
  store i32 1, i32* %10, align 4, !dbg !3261
  br label %137, !dbg !3261

137:                                              ; preds = %127, %118, %105, %70, %43
  %138 = load i32, i32* %10, align 4, !dbg !3262
  ret i32 %138, !dbg !3262
}
