...
function where the target field is written, then inject encyption function call. Besides, this is i32-based mutation.
'''
...
class InsertEncFunctionCall:
    ...
    def insertFunctionCall(self):
        ...
        instruction_1 = "  %{} = call i32 @simple_encrypt(i32 %{})\n".format(current_numb+1, current_numb)
