...
then inject change field value function call. Besides, this is i16-based mutation.
'''
...
class ChangeFieldValue:
    ...
    def insertStructAndNonce(self):
        ...
        nonce_list_str = "@{}.nonce = private unnamed_addr constant [4 x i16] [i16 13, i16 28, i16 92, i16 65], align 2\n".format(function_name)
    ...
    def insertChangeFieldValue(self, datas):
        ...
        wdir = os.getcwd()
        with open(wdir + "/templates/int16/field_value_change_int16.txt", 'r') as f:
    ...
    def insertFunctionCall(self, datas):
        ...
        instruction_1 = "  %{} = call i16 @change_static_value(i16 %{})\n".format(current_numb+1, current_numb)
