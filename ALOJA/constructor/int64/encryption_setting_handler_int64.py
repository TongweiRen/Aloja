...
function where the target field is written, then inject encyption function call. Besides, this is i64-based mutation.
'''
...
class InsertEncFunctionCall:
    ...
    def insertFunctionCall(self):
        ...
        instruction_1 = "  %{} = call i64 @simple_encrypt(i64 %{})\n".format(current_numb+1, current_numb)
